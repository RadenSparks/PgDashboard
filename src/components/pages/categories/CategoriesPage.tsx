...
import { Input, FormControl, FormLabel, Stack, Box } from "@chakra-ui/react";
...
const CategoriesPage = () => {
  ...
  return (
    <Box sx={{ p: 8, alignContent: "center", justifyContent: "center", alignItems: "center" }}>
      <Box sx={{flex: 1, maxWidth: "800px", margin: "0 auto"}}>
