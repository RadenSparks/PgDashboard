...
const GallerySlider = ({ images, renderAction }: GallerySliderProps) => {
  ...
  return (
    <div
      ...
      ref={sliderRef}
      tabIndex={0}
      aria-label="Trình chiếu ảnh, dùng phím mũi tên để chuyển ảnh"
    >
      {/* Main image preview */}
      ...
      <div className="text-xs text-gray-400 mt-2">
        Dùng phím <span className="font-semibold text-blue-600">←</span> / <span className="font-semibold text-blue-600">→</span> để chuyển ảnh
      </div>
    </div>
  );
};
